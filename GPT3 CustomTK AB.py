...
# Leer el archivo APIKEY.txt y asignar la APIKEY a la variable openai.api_key
...
class App(ctk.CTk):
    ...
    def __init__(self):
        ...
        entry_bot = ctk.CTkTextbox(self , height=20 , wrap=ctk.WORD , state=ctk.DISABLED )
